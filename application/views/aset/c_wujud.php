        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form class="form-horizontal" action="<?=base_url('aset_wujud/simpan')?>" autocomplete="off" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="card-bod">
                    <?php if (validation_errors()): ?>
                      <div class="alert alert-danger col-md-8 alert-dismisable">
                    ...
                    <form class="form-horizontal" action="<?=base_url('aset_wujud/simpan')?>" autocomplete="off" method="post">
                      <div class="card-body">
                        <div class="form-group row">
                          <label for="kode_aset" class="col-sm-4 col-form-label">Kode Aset</label>
                          <div class="col-sm-6">
                            <input type="text" class="form-control" name="kode_aset" placeholder="0000/XXX/20XX" required autofocus>
                          </div>
                        </div>
                      <div class="form-group row">
                        <label for="id_barang" class="col-sm-4 col-form-label">Nama Aset</label>
                        <div class="col-sm-6">
                      ...
                      <div class="form-group row">
                        <label for="id_lokasi" class="col-sm-4 col-form-label">Lokasi Aset</label>
                        <div class="col-sm-6">
                      ...
                      <div class="form-group row">
                        <label for="umur_ekonomis" class="col-sm-4 col-form-label">Umur Ekonomis</label>
                        <div class="col-sm-6">
                      ...
                      <div class="form-group row">
                        <label for="harga" class="col-sm-4 col-form-label">Nilai Aset</label>
                        <div class="col-sm-6">
                          <div class="input-group mb-3">
                      ...
                      <div class="form-group row">
                        <label for="jenis_bantuan" class="col-sm-4 col-form-label">Jenis Bantuan</label>
                        <div class="col-sm-6">
                      ...
                      <div class="form-group row">
                        <label for="tanggal_terima" class="col-sm-4 col-form-label">Generate QR Code?</label>
                        <div class="col-sm-6">
