      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <tbody>
            <tr>
              <td>
              <img src="<?= isset($mt['foto']) ? base_url("src/img/aset/{$mt['foto']}") : base_url('src/img/aset/default_image.jpg'); ?>" alt="" style="width:250px;height:250px;">
              </td>
            </tr>
            </tbody>
          ...
          <table class="table table-striped">
            ...
            <table class="table table-striped">
                            ...
                            <tr>
                              <td rowspan="5">
                                <?php if (isset($mt)) : ?>
                                    <img src="<?= base_url('src/img/wujud/' . $mt['foto']); ?>" alt="Gambar Aset" style="width:100px;height:100px;">
                                <?php else : ?>
